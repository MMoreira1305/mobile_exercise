...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpView(){
        ...
        binding.textView2.text = getString(R.string.welcome_message, username)
    }
    ...
    private fun addContact() {
        ...
        val sex = binding.editTextSexo.text.toString()
    ...
    private fun isFormValid(person: Person): Boolean =
        validateField(person.name, binding.editTextName, R.string.name)
                ...
                && validateField(person.sex, binding.editTextSexo, R.string.sex)
